...
import com.bad.ctrlz.configuraciones.Seguridad.CorreoElectronico.EmailConf;
...
public class EmailView {
     ...
     */
    public String generateEmailTemplate(String titulo, String nombre, String contrasena,
            String descripcion, String consideracion, String correo) {
        ...
        html.append("<div class='security-notice'>")
                ...
                .append("<p>&copy; 2025 ").append(emailConfig.getCompanyName())
                .append(". Todos los derechos reservados.</p>")
                .append("</div>")
                .append("</div>")
                .append("</body>")
                .append("</html>");
