import { x as p, b as d, p as u, Z as v, s as f, P as b, z as m, n as g } from "./copilot-DE_b6Vgc.js";
import { r as c } from "./state-BOtukX-R.js";
import { m as y, e as k } from "./overlay-monkeypatch-D2oQ4eNL.js";
import { B as w } from "./base-panel-B3lCQjkN.js";
import { i as x } from "./icons-DE7BzfOW.js";
...
var A = Object.defineProperty, P = Object.getOwnPropertyDescriptor, o = (e, t, s, n) => {
  for (var i = n > 1 ? void 0 : n ? P(t, s) : t, l = e.length - 1, r; l >= 0; l--)
    (r = e[l]) && (i = (n ? r(t, s, i) : r(i)) || i);
  return n && i && A(t, s, i), i;
};
...
let a = class extends w {
  ...
  openGithub(e, t) {
    ...
    const s = e.replace(/\n/g, "%0A"), n = `${t.items.find((r) => r.value === this.type)?.ghTitle}`, i = t.description !== "" ? t.description : F, l = D.replace("{description}", i).replace("{versionsInfo}", s);
    window.open(`${h}?title=${n}&body=${l}`, "_blank")?.focus();
  }
};
o([
  c()
