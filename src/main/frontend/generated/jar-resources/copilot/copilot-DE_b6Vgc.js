...
const un = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), he = "copilot-", Us = "24.6.9", Hc = "attention-required", Kc = "https://plugins.jetbrains.com/plugin/23758-vaadin", qc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Wc(e) {
...
function Tl() {
  Ee.push(import("./copilot-log-plugin-BKZilcP-.js")), Ee.push(import("./copilot-info-plugin-BMotuFLe.js")), Ee.push(import("./copilot-features-plugin-D9C5d-Nx.js")), Ee.push(import("./copilot-feedback-plugin-BA4EuThB.js")), Ee.push(import("./copilot-shortcuts-plugin-BVNvfoRQ.js"));
}
function kl() {
  {
...
let Jr = class extends Dl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-Cb8Os5Pg.js"), await import("./copilot-init-step2-D1Di7O2a.js"), Gs(), Tl(), this.tabIndex = 0, Tt.hostConnectedCallback(), window.addEventListener("keydown", Lr), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
